 ...
 */
public class OperatorIntake extends SubsystemBase {

    /* Call intakeMotor defined in RobotMap */
    //CANSparkMax intakeMotor = RobotMap.intakeMotor;
    
    SpeedControllerGroup operatorIntakeGroup = RobotMap.operatorIntakeGroup;
    ...
    public void lower() {
        ...
        operatorIntakeGroup.set(-Config.operatorIntakeSpeed);
        state = false;
    }
    ...
    public void moveOut() {
        ...
        operatorIntakeGroup.set(Config.operatorIntakeSpeed * -1);
    }
}
