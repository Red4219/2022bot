 ...
 */
public class OperatorLiftIntake extends SubsystemBase {

    /* Call intakeMotor defined in RobotMap */
    //CANSparkMax intakeMotor = RobotMap.intakeMotor;
    SpeedControllerGroup intakeArmGroup = RobotMap.intakeArmGroup;
    SpeedControllerGroup intakeGroup = RobotMap.intakeGroup;
    

    /* Call intakeSolenoid defined in RobotMap */
    //CANSparkMax intakeLiftMotor = RobotMap.intakeLiftMotor1;
    ...
    public void periodicIntake() {
        ...
        //     if (RPM < 10 ) {
        //         failCount++;
        //         System.out.println("FAIL INC");        // clankers
    ...
    public void lower() {
        ...
        intakeArmGroup.set(-Config.intakeDownSpeed);
        state = false;
    }
     ...
     */
    public void raise() {
        intakeArmGroup.set(Config.intakeLiftSpeed);
        state = true;
    }
    ...
    public void intake() {
        ...
        //intakeArmGroup.set(Config.intakeSpeed);
        intakeGroup.set(Config.intakeSpeed);
    }
    ...
    public void stop() {
        ...
        //intakeArmGroup.stopMotor();
        intakeGroup.stopMotor();
    }
    ...
    public void moveOut() {
        ...
        //intakeArmGroup.set(Config.intakeSpeed * - 1);
        intakeGroup.set(Config.intakeSpeed * -1);
    }
}
